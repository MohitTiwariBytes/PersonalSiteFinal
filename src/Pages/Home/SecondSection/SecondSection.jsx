...
import hackClubFinder from "../../../assets/Images/icon-square.png";
    ...
    <div className="main-second-section-home">
      <div className="secondSectionHome">
        ...
        <div className="projects">
          ...
          <div className="project">
            <img id="adsk" src={astrohacksLogo} alt="" />
            <div className="wagera">
              <span>Astrohacks</span>
              <div className="icons">
                <svg
                  onClick={() => {
                    window.location.replace(
                ...
                <svg
                  onClick={() => {
                    window.location.replace(
                      "https://github.com/MohitTiwariBytes/AstroHacks-V2"
                    );
                  }}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
